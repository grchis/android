...
if ($names != '') { $upd_names = ", `fullname` = '".$names."'"; } else { $upd_names = ''; }
if ($phone != '') { $upd_phone = ", `telefon` = '".$phone."'"; } else { $upd_phone = ''; }
if ($cod_postal != '') { $upd_cod_postal = ", `cod_postal` = '".$cod_postal."'"; } else { $upd_cod_postal = ''; }
if ($adresa != '') { $upd_adresa = ", `adresa` = '".$adresa."'"; } else { $upd_adresa = ''; }
//obtin id judet
...
//update profiles
$query = "UPDATE #__sa_profiles SET `tip_cont` = '0' ".$upd_names.$upd_phone.$upd_cod_postal.$upd_adresa.$upd_judet.$upd_city.$upd_poza." WHERE `uid` = '".$uid."'";
$db->setQuery($query);
$db->query();
//update mail & pass
...
$query = "UPDATE #__users SET `id` = '".$uid."' ".$upd_email.$upd_pass." WHERE `id` = '".$uid."'";
$db->setQuery($query);
$db->query();
