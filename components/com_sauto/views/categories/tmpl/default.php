...
<h1><?php echo $this->site_title; ?></h1>
	...
	<div id="content9">
		...
		if ($uid == 0) {
			//client
			require_once("components/com_sauto/assets/includes/categories_v.php");
		} else {
			if ($tip == 0) {
			require_once("components/com_sauto/assets/includes/categories_c.php");
			} elseif ($tip == 1) {
			//dealer
			require_once("components/com_sauto/assets/includes/categories_d.php");
			}
		}
		?> 						
	</div>
