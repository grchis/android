...
//actualizam anuntul
$query = "UPDATE #__sa_anunturi SET ".$upd_titlu_anunt." ".$upd_anunt." ".$upd_cilindree." ".$upd_serie_caroserie."  `nr_usi` = '".$nr_usi."', `nou` = '".$nou."', `sh` = '".$sh."', `an_fabricatie` = '".$an_fabricatie."', `carburant` = '".$carburant."', `caroserie` = '".$caroserie."', `serie_caroserie` = '".$serie_caroserie."' ".$marca_noua_id." ".$model_nou_id." WHERE `proprietar` = '".$uid."' AND `id` = '".$id."'";
$db->setQuery($query);
$db->query();
