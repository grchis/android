...
$caroserie =& JRequest::getVar( 'caroserie', '', 'post', 'string' );$transmisie =& JRequest::getVar( 'transmisie', '', 'post', 'string' );
...
}if ($transmisie == '') {	$upd_transmisie = '';} else {	$upd_transmisie = " `transmisie` = '".$transmisie."', "; }
if ($anunt == '') {
	$upd_anunt = '';
} else {
...
//actualizam anuntul
$query = "UPDATE #__sa_anunturi SET ".$upd_titlu_anunt." ".$upd_anunt." ".$upd_transmisie." ".$upd_cilindree." ".$upd_serie_caroserie."  `an_fabricatie` = '".$an_fabricatie."', `judet` = '".$id_judet."', `city` = '".$city."', `carburant` = '".$carburant."', `caroserie` = '".$caroserie."', `serie_caroserie` = '".$serie_caroserie."' ".$marca_noua_id." ".$model_nou_id." WHERE `proprietar` = '".$uid."' AND `id` = '".$id."'";
$db->setQuery($query);
$db->query();
