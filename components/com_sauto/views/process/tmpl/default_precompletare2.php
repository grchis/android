...
$link_redirect = JRoute::_('index.php?option=com_sauto&view=make_offer2');
...
if ($xml_exist == true) {
	...
	$query = "INSERT INTO #__sa_temp_firme (`cui`, `firma`, `sediu`, `city`, `phone`, `nr_reg`, `judet`, `cp`, `id_anunt`, `mesaj`, `pret`, `moneda`) 
	VALUES ('".$old_cf."', '".$g_firma."', '".$g_adresa."', '".$g_city."', '".$g_phone."', '".$g_reg."', '".$g_region."', '".$g_zip."', '".$id_anunt."', '".$mesaj."', '".$pret."', '".$moneda."')";
	$db->setQuery($query);
	$db->query();
