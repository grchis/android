...
<div id="wrapper9">
	...
	<div id="content9">
		<h1 align="center"><?php echo $this->site_title; ?></h1>
		<?php
		//verificare tip utilizator
		if ($tip == 0) {
			//client
			require_once("components/com_sauto/assets/includes/profile_c.php");
		} elseif ($tip == 1) {
			//dealer
			require_once("components/com_sauto/assets/includes/profile_d.php");
		}
		?> 						
	</div>
