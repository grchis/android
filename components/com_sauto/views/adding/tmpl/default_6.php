...
$anunt =& JRequest::getVar( 'anunt6', '', 'post', 'string', JREQUEST_ALLOWHTML );
...
if ($register_anunt == 1) {
	...
	(`titlu_anunt`, `anunt`, `tip_anunt`, `marca_auto`, `model_auto`, `an_fabricatie`, `cilindree`, `carburant`, `caroserie`, `serie_caroserie`, `proprietar`, `data_adaugarii`, `status_anunt`, `raportat`, `pret`, `data_expirarii`) 
	VALUES 
	('".$titlu_anunt."', '".$anunt."', '6', '".$marca_auto_id."', '".$model_auto_id."', '".$an_fabricatie."', '".$cilindree."', '".$carburant."', '".$caroserie."', '".$serie_caroserie."', '".$uid."', '".$curentDate."', '1', '0', '".$price."', '".$expiryDate."')";
	$db->setQuery($query);
	$db->query();
