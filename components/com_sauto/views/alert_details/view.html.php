 ...
 * @package    sauto
 */
class SautoViewAlert_details extends JViewLegacy
{
    /**
    ...
    public function display($tpl = null)
    {
		...
		case '':
		default:
		$meta_title = JText::_('SAUTO_META_TITLE_DETAILS_ALERTE_PAGE');	
		$site_title = JText::_('SAUTO_SITE_TITLE_DETAILS_ALERTE_PAGE');			
