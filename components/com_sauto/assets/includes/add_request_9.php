...
$query = "INSERT INTO #__sa_temporar (`titlu_anunt`, `anunt`, `tip_anunt`, `marca_auto`, `model_auto`, `an_fabricatie`, `cilindree`, `carburant`,  `proprietar`, `data_adaugarii`, `status_anunt`, `raportat`, `data_expirarii`) VALUES ('".$titlu_anunt."', '".$anunt."', '9', '".$marca_auto_id."', '".$model_auto_id."', '".$an_fabricatie."', '".$cilindree."', '".$carburant."',  '0', '".$curentDate."', '1', '0', '".$expiryDate."')";
$db->setQuery($query);
$db->query();
