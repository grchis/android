...
$query = "INSERT INTO #__sa_temporar (`titlu_anunt`, `anunt`, `tip_anunt`, `marca_auto`, `model_auto`, `an_fabricatie`, `cilindree`, `carburant`, `nr_usi`, `caroserie`, `serie_caroserie`, `nou`, `sh`, `proprietar`, `data_adaugarii`, `status_anunt`, `raportat`, `data_expirarii`, `garaj`) VALUES ('".$titlu_anunt."', '".$anunt."', '1', '".$marca_auto_id."', '".$model_auto_id."', '".$an_fabricatie."', '".$cilindree."', '".$carburant."', '".$nr_usi."', '".$caroserie."', '".$serie_caroserie."', '".$nou."', '".$sh."', '0', '".$curentDate."', '1', '0', '".$expiryDate."', '".$garaj."')";
$db->setQuery($query);
$db->query();
