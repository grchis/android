...
$anunt =& JRequest::getVar( 'anunt3', '', 'post', 'string', JREQUEST_ALLOWHTML );
$time = time();
...
$query = "INSERT INTO #__sa_temporar (`titlu_anunt`, `anunt`, `tip_anunt`, `marca_auto`, `model_auto`,  `cilindree`, `carburant`, `nr_usi`, `caroserie`, `proprietar`, `data_adaugarii`, `status_anunt`, `raportat`, `data_expirarii`, `judet`, `city`, `transmisie`) VALUES ('".$titlu_anunt."', '".$anunt."', '3', '".$marca_auto_id."', '".$model_auto_id."', '".$cilindree."', '".$carburant."', '".$nr_usi."', '".$caroserie."',  '0', '".$curentDate."', '1', '0', '".$expiryDate."', '".$id_judet."', '".$localitate."', '".$transmisie."')";
$db->setQuery($query);
$db->query();
