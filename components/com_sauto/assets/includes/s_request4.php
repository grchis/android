...
<div>
		<h2><?php echo JText::_('SAUTO_TIP_ANUNT_SEARCH').' '.JText::_('SAUTO_TIP_ANUNT_DETAIL4'); ?></h2>
	</div>
	...
	<div>
			...
			<div id="sa_city">
				<select name="none"><option value=""><?php echo JText::_('SAUTO_FORM_SELECT_CITY'); ?></option></select>
			</div>
	...
	<div>
		<input type="text" name="buget_alocat" value="" size="57" />
