...
<div>
	...
	<div>
	<span>	
		<?php echo JText::_('SAUTO_INTRE').' '; ?><input type="text" name="buget_min" value="<?php echo $buget_min; ?>"  size="15%"/>
		<?php echo ' '.JText::_('SAUTO_SI').' '; ?><input type="text" name="buget_max" value="<?php echo $buget_max; ?>" size="15%" />
	...
	<div>
			<textarea 
				name="anunt4" id="anunt4" cols="60" rows="20" style="width: 500px; height: 150px;" class="mce_editable" aria-hidden="true">
			</textarea>
			</div>
