...
jQuery(document).ready(function() {
	...
	// overrides
	var elements = ['layout_override', 'tools_for_pages', 'suffix_override', 'module_override', 'mootools_for_pages', 'sidebar_left_width_for_pages', 'sidebar_right_width_for_pages', 'inset_width_for_pages', 'inner_inset_width_for_pages'];
	...
	function getUpdates() {
		...
		var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_news2_j30';
