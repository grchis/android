...
class GKTemplate {
    ...
    public function getParameters() {
        ...
        $this->config->set('sidebar_left_width_override', $this->utilities->overrideArrayParse($this->API->get('sidebar_left_width_for_pages', '')));
        $this->config->set('sidebar_right_width_override', $this->utilities->overrideArrayParse($this->API->get('sidebar_right_width_for_pages', '')));
