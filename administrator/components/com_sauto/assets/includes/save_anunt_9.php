...
//actualizam anuntul
$query = "UPDATE #__sa_anunturi SET ".$upd_titlu_anunt." ".$upd_anunt." ".$upd_cilindree."   `an_fabricatie` = '".$an_fabricatie."', `carburant` = '".$carburant."' ".$upd_marca." ".$upd_model." WHERE `id` = '".$id."'";
$db->setQuery($query);
$db->query();
