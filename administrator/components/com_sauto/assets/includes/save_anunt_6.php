...
//actualizam anuntul
$query = "UPDATE #__sa_anunturi SET ".$upd_titlu_anunt." ".$upd_anunt." ".$upd_cilindree." ".$upd_serie_caroserie."  `an_fabricatie` = '".$an_fabricatie."', `carburant` = '".$carburant."', `caroserie` = '".$caroserie."', `serie_caroserie` = '".$serie_caroserie."' ".$upd_marca." ".$upd_model." WHERE `id` = '".$id."'";
$db->setQuery($query);
$db->query();
