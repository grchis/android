...
<form action="<?php echo $link_form; ?>" method="post" enctype="multipart/form-data">
	<div>
		<h2>Piese auto :: Editare anunt</h2>
	</div>
	...
	<div>
		<select name="stare">
			<option value="">Alege stare auto</option>
			<?php
			...
			foreach ($stare_q as $st) {
				echo '<option value="'.$st->id.'"';
					if ($st->id == $rezult->stare) { echo ' selected'; }
	...
	*/ 
	...
	<div>
			...
			echo $editor->display('anunt1', $rezult->anunt, '300', '150', '60', '20', false);
			?>
			</div>
